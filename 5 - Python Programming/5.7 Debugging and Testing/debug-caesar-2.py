...
def encryptMessage(message, cipherKey, alphabet):
    ...
    #I realized that the code was only encrypting uppercase letters because the input from the user has not been .upper()
    #Replacing uppercaseMessage = message with uppercaseMessage = message.upper() should do the trick.
