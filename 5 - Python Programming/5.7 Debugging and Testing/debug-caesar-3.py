...
def decryptMessage(message, cipherKey, alphabet):
    ...
    #Realized that theproblem was the decrypted message was still encrypted
    #Caused by using the cipherKey to decrypt the message
    #Replacing cipherKey with decryptKey should do the trick
